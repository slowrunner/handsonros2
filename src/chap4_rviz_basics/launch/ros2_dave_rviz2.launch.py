# FILE: ros2_dave_rviz2.launch.py
# PURPOSE:  launch robot and joint state publishers and rviz2 with dave.urdf
...
def generate_launch_description():
    ...
    urdf_fn_arg = LaunchConfiguration('urdf_fn_arg', default='dave.urdf')
